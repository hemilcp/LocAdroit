...
import com.example.DBClasses.LocationReminder;
import com.example.DBHelper.MyDBHelper;
import com.example.locationassistant.EventsFragment;
...
public class CardAdapter extends BaseAdapter {
    ...
    public List<LocationReminder> remlist;
    
    public CardAdapter(Context c) {
        mContext = c;
    }

    public CardAdapter(EventsFragment topRatedFragment) {
    	mContext = topRatedFragment.getActivity();
    	dbhelp = new MyDBHelper(mContext);
    	remlist = dbhelp.getReminders(); 
    	}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {  
        	...
        	TextView note = new TextView(mContext);
         	...
         	note.setText(remlist.get(position).getTitle().toString());
  			desc.setText("At "+remlist.get(position).getLoc().toString());
